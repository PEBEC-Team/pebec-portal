...
export default defineSchema({
  ...
  tickets: defineTable({
    ...
    .index("byTicketNumber", ["ticketNumber"]),
  ...
  notifications: defineTable({
    ...
    .index("byUser", ["userId"])
    .index("byType", ["type"])
    .index("byMeeting", ["meetingId"])
    .index("byTicket", ["ticketId"])
    .index("byTask", ["taskId"])
    .index("byUserAndTicket", ["userId", "ticketId"]),
  ...
  dli_submissions: defineTable({
      ...
      v.object({
        ...
        responses: v.array(
          v.object({
            question: v.string(),
            answer: v.optional(
              v.union(v.string(), v.array(v.string()), v.id("_storage")),
            ),
          }),
        ),
      }),
    ...
    .index("byDliTemplate", ["dliTemplateId"])
    .index("bySubmittedBy", ["submittedBy"]),
  ...
  dli_progress: defineTable({
    ...
    .index("byUserAndDLI", ["userId", "dliTemplateId"])
    .index("byState", ["state"]),
