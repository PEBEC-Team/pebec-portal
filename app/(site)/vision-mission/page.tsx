...
const milestones = [
  { year: "2016", title: "Establishment of PEBEC", description: "PEBEC was created to oversee Nigeria's business environment reforms.", date: "08/01/2016" },
  { year: "2018", title: "Global Recognition", description: "Nigeria recognized as one of the top 10 most improved economies globally.", date: "10/05/2018" },
  { year: "2019", title: "Ease of Doing Business Index", description: "Nigeria moved up 39 places in the Doing Business Index.", date: "12/08/2019" },
  { year: "2020", title: "150+ Business Reforms", description: "More than 150 reforms implemented to ease business processes.", date: "06/12/2020" },
  { year: "2021", title: "State-Level Reforms", description: "32 Nigerian states implemented 43 business reforms.", date: "04/09/2021" },
  { year: "2022", title: "National Action Plan 5.0", description: "Launch of NAP 5.0 to enhance business reforms nationwide.", date: "07/03/2022" },
  { year: "2023", title: "Global Competitiveness", description: "Improvements in 3 out of 4 business enabling environments.", date: "11/10/2023" },
];
...
const MissionVisionMilestones = () => {
  ...
  return (
    <main className="font-[sans-serif] mt-25">
      <section
        className="relative bg-cover bg-center h-[350px] flex flex-col justify-center items-center text-white text-center px-6"
      ...
      >
        ...
        >
          <span>PEBEC</span>
          <RotatingText
            texts={["Mission", "Vision", "Milestones"]}
            mainClassName="text-4xl md:text-5xl font-extrabold text-white"
            staggerFrom={"last"}
            initial={{ y: "100%" }}
            animate={{ y: 0 }}
            exit={{ y: "-120%" }}
        ...
        <button
          ...
          className="mt-6 px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-semibold rounded-lg transition-all"
        >
          Explore Milestones ↓
        </button>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
        ...
        <motion.div initial={{ opacity: 0, x: 50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} className="flex justify-center">
...
<section
  ...
  style={{ backgroundImage: "url('/images/milestone.svg')", backgroundSize: "cover", backgroundRepeat: "no-repeat" }}
>
  {/* Faded Overlay for Background (80% transparency) */}
    ...
    {milestones.map((milestone, index) => {
      ...
      return (
        <motion.div
          ...
          className={`relative flex items-center w-full md:w-1/2 mx-auto py-6 ${
