...
import { 
  ...
  FaMapMarkerAlt, FaBuilding, FaCalendarAlt
} from "react-icons/fa";
...
export default function GuestTicketDetailsPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto mt-20 p-6 bg-white shadow-lg rounded-md">
      ...
      {ticket.resolutionNote && (ticket.status === "closed" || ticket.status === "resolved") && (
        <div className="mt-6 p-4 border rounded-lg bg-gray-50">
