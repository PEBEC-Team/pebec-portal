...
export default function ReportGovModal({ onClose }: { onClose: () => void }) {
    ...
    <Dialog open onOpenChange={handleDialogClose}>
      <DialogContent className="max-w-3xl mx-auto p-8">
        ...
        <div className="flex justify-center mt-4 mb-8">
          <Button
            className="bg-green-600 hover:bg-green-700 text-white px-6 py-2 text-sm font-medium rounded-full shadow"
