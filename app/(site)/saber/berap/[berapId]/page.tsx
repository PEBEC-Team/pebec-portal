...
export default function BERAPDetailPage() {
  ...
  return (
    <>
      ...
      <Button
  onClick={() => router.back()}
  className="inline-flex items-center gap-2 text-blue-700 hover:underline text-sm font-medium px-10"
>
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
          ...
          {materials?.length === 0 ? (
            ...
            <ul className="space-y-3">
              {materials!.map((mat) => (
                <li
                  key={mat._id}
                  className="bg-blue-50 border border-blue-100 rounded-md px-4 py-3 flex items-center justify-between"
                >
        ...
        <div className="space-y-6">
          <div
            ...
            dangerouslySetInnerHTML={{ __html: berap.description }}
          />

          {berap.privateSectorNotes && (
