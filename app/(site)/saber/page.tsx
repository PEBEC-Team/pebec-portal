...
export default function SaberUserPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto mt-30">
      ...
      <div className="relative w-full h-[300px]">
        ...
        <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center text-center px-4 md:px-10">
          <div className="flex items-center gap-3">
            ...
            <motion.h1
              className="text-5xl md:text-6xl font-extrabold tracking-widest text-white drop-shadow-md"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              transition={{
                delay: 0.5,
          ...
          <motion.p
            className="text-lg md:text-xl text-white/90 mt-2"
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 1 }}
          >
      ...
      {/* Extended Intro */}
      <motion.div
        className="bg-gray-50 border border-gray-200 text-gray-800 text-sm p-6 md:p-10 mt-10 rounded-lg leading-relaxed space-y-4"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
          ...
          <div className="space-y-8">
            ...
            >
              {[...dlis].sort((a, b) => a.number - b.number).map((dli) => {
                const Icon =
                  (FaIcons as any)[dli.icon?.replace("Fa", "Fa")] || FaIcons.FaRegCircle;
