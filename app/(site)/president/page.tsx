      ...
      {isWelcomeVisible && (
        <div className="bg-white shadow rounded-lg p-6 mb-6 relative">
          ...
          <h1 className="text-2xl font-bold text-gray-800">
            Welcome, Mr. President {firstName} {lastName}
          </h1>
          <p className="text-gray-600 mt-1">
            Use the side navigation to access national-level analytics across Saber Program, ReportGov submissions, and insights from MDAs.
          </p>
        </div>
      )}
