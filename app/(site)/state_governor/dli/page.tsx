  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="text-center mb-6">
        {userData.state && (
          <span className="bg-green-100 text-blue-800 text-sm font-semibold px-4 py-1 rounded-full shadow inline-block mb-2">
        ...
        {stateDLIs.map((dli) => {
          ...
          return (
            <div key={dli._id} className="bg-white shadow-xl rounded-2xl p-6 flex flex-col h-full relative">
              ...
              {/* Progress */}
            {/* Progress Section (aligned bar and % evenly) */}
<div className="mt-4">
