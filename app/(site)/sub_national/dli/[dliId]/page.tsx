...
export default function StateDLIProgressPage() {
  ...
  const { dliId } = useParams();
  const dliTemplate = useQuery(api.dli.getDliTemplate, { id: dliId as Id<"dli_templates"> });
  const userProgress = useQuery(api.dli.getUserDLIProgress, { dliTemplateId: dliId as Id<"dli_templates"> });
