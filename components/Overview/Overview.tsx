...
export default function OverviewBanner() {
  ...
  return (
    <section className="relative bg-gradient-to-r from-green-600 via-green-500 to-green-700 text-white py-20">
      <div className="container mx-auto px-6 flex flex-col-reverse md:flex-row items-center justify-between gap-10">
        ...
        <div className="w-full md:w-1/2 text-center md:text-left">
          ...
          <Button
            ...
            className="mt-6 bg-green-800 hover:bg-green-900 text-white font-semibold py-3 px-6 rounded-lg text-lg transition-transform duration-300 transform hover:scale-105"
          >
            Why PEBEC?
          </Button>
        </div>
