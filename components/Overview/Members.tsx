...
const memberImages = [
  "/images/members/member1.jpeg",
  "/images/members/member2.png",
  "/images/members/member3.png",
];
...
export default function Members() {
  ...
  return (
    <section className="relative bg-white dark:bg-gray-900 py-16 px-6 overflow-hidden">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between">
        ...
        {/* Right Side - Member Count Card & Floating Bubbles */}
        <motion.div
