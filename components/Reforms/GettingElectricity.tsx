...
export default function GettingElectricity() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-8 bg-white rounded-lg shadow-lg text-gray-800">
      ...
      {/* Video Section Styled as a Card */}
      <div className="relative flex justify-center items-center w-full h-72 bg-gray-300 rounded-xl overflow-hidden cursor-pointer shadow-md" onClick={() => setVideoOpen(true)}>
        {!videoOpen ? (
          ...
          <iframe
            ...
            title="Getting Electricity Reform"
            allowFullScreen
          ></iframe>
        )}
      </div>
      ...
      <div className="mt-8 text-center">
        <a
          href="https://pebec.gov.ng/reforms-implemented/getting-electricity/"
          target="_blank"
          className="inline-block bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg text-lg font-semibold transition duration-300 shadow-lg"
        >
          Learn More
        </a>
      </div>
