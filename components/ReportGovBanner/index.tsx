...
export default function HeroSection() {
  ...
  return (
    <div className="w-full flex justify-center bg-[#1A1F2B] py-6 px-4">
      <div className="w-full max-w-5xl flex flex-col lg:flex-row items-center justify-between px-6 lg:px-10 py-5 bg-[#111827] text-white rounded-lg shadow-md space-y-4 lg:space-y-0">
        ...
        <div className="w-full lg:w-auto flex justify-center lg:justify-end">
          <button
            ...
            className="bg-red-600 hover:bg-red-500 text-white font-medium py-2 px-6 rounded-lg text-sm lg:text-base transition-all w-full lg:w-auto"
          >
            Find out more
          </button>
        </div>
