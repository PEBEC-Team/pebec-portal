...
export default function TicketForm() {
  ...
  return (
    <form className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-md space-y-6" onSubmit={handleSubmit}>
      ...
      <div>
        ...
        <Select
          onValueChange={(value) => setForm({ ...form, assignedMDA: value })}
          required
        >
          <SelectTrigger>
      ...
      {/* File Upload (Future Integration with Convex) */}
      <div>
        ...
        <div className="flex items-center gap-3">
          <Input
            ...
            onChange={(e) => setForm({ ...form, supportingDocuments: Array.from(e.target.files || []) })}
          />
