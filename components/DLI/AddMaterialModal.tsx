...
interface AddMaterialModalProps {
  open: boolean;
  onClose: () => void;
  dliOptions: { id: Id<"dli">; label: string }[];
  berapOptions: { id: Id<"berap">; label: string }[];
  onSave: (data: {
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            <div className="w-1/2">
              ...
              <select
                ...
                value={parentType}
                onChange={(e) => setParentType(e.target.value as "dli" | "berap")}
              >
          ...
          <div>
            ...
            <select
              className="w-full border p-2 rounded"
              value={type}
              onChange={(e) => setType(e.target.value as "note" | "video" | "document")}
            >
