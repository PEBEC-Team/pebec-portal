  ...
  <span className="mt-1 border border-gray-300 bg-gray-100 text-blue-600 dark:border-gray-600 dark:bg-gray-700 flex h-5 w-5 items-center justify-center rounded peer-checked:bg-primary">
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M9.70704 0.792787C9.89451 0.980314 9.99983 1.23462 9.99983 1.49979C9.99983 1.76495 9.89451 2.01926 9.70704 2.20679L4.70704 7.20679C4.51951 7.39426 4.26521 7.49957 4.00004 7.49957C3.73488 7.49957 3.48057 7.39426 3.29304 7.20679L0.293041 4.20679C0.110883 4.01818 0.0100885 3.76558 0.0123669 3.50339C0.0146453 3.24119 0.119814 2.99038 0.305222 2.80497C0.490631 2.61956 0.74144 2.51439 1.00364 2.51211C1.26584 2.50983 1.51844 2.61063 1.70704 2.79279L4.00004 5.08579L8.29304 0.792787C8.48057 0.605316 8.73488 0.5 9.00004 0.5C9.26521 0.5 9.51951 0.605316 9.70704 0.792787Z"
        fill="white"
      />
    </svg>
  </span>
    ...
    />
            ...
            >
              ...
              <div className="5 mb-7">
                ...
                <p>5th Floor, Total House 1, Plot 247 Herbert Macaulay Way, Central Business District (Opposite NNPC Towers), Abuja, FCT</p>
              </div>
              <div className="5 mb-7">
                <h3 className="mb-4 text-metatitle3 font-medium text-black dark:text-white">
                  Email Address
