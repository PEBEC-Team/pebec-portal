...
export default function GovernorSidebar({ isOpen, setIsOpen }) {
  ...
  const toggleDropdown = (section) => {
    ...
    setOpenDropdowns((prev) => {
      ...
      return { ...newState, [section]: !prev[section] };
    });
  };
  ...
  const menuSections = [
    ...
    },
    {
      ...
      items: [
        { name: "Overview", path: "/state_governor/saber-overview" },
        { name: "Materials", path: "/state_governor/materials" },
      ],
    },
    {
      name: "Profile",
                  ...
                  {openDropdowns[section.name] && (
                    <div className="pl-6">
                      {section.items.map((item) => (
                        ...
                        >
                          <div
                            className={`p-3 rounded-lg text-gray-700 hover:bg-gray-100 cursor-pointer transition-all duration-300 ${
                              pathname === item.path
