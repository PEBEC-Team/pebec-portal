...
const notifications = [
  ...
  { id: 2, text: "How to Pay Taxes Easily", icon: <FaMoneyBillWave className="text-white text-lg" />, bgColor: "bg-green-600" },
  { id: 3, text: "How to register your business", icon: <FaBusinessTime className="text-white text-lg" />, bgColor: "bg-green-600" },
  { id: 4, text: "How to get permits", icon: <FaBusinessTime className="text-white text-lg" />, bgColor: "bg-green-600" },
  { id: 5, text: "Report a problem", icon: <FaExclamationTriangle className="text-white text-lg" />, bgColor: "bg-red-600" },
];
...
const Hero = () => {
  ...
  return (
    <section className="overflow-hidden pb-20 pt-32 md:pt-40 xl:pb-25 xl:pt-46 relative">
      {/* Background Image */}
      ...
      <motion.div
        ...
        animate={{ x: [0, 400, -300, 0], y: [0, -100, 50, 0], opacity: [0, 1, 1, 0] }}
          ...
          <div className="md:w-1/2 text-center md:text-left">
            ...
            <h1 className="mb-5 text-3xl xl:text-5xl font-extrabold text-black dark:text-white leading-tight flex flex-wrap justify-center md:justify-start gap-2">
              ...
              <span className="flex items-center gap-2">
                <span>Nigeria</span>
                <RotatingText
                  texts={["Efficient", "Easy", "Digital", "Transparent"]}
                  mainClassName="px-3 bg-green-300 text-black py-1 rounded-md font-bold"
                  staggerFrom="last"
                  initial={{ y: "100%" }}
                  animate={{ y: 0 }}
                  exit={{ y: "-120%" }}
