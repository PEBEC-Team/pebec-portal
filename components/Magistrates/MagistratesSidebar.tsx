...
export default function MagistratesSidebar({ isOpen, setIsOpen }) {
  ...
  const menuSections = [
    { name: "Dashboard", icon: <LayoutDashboard className="w-5 h-5" />, path: "/magistrates" },
    { name: "Send letter", icon: <FaEnvelopeOpenText className="w-5 h-5" />, path: "/magistrates/send-letters" },
    { name: "Received letters", icon: <FaEnvelopeOpenText className="w-5 h-5" />, path: "/magistrates/received-letters" },
    { name: "Reports", icon: <FaFileAlt className="w-5 h-5" />, path: "/magistrates/reports" },
